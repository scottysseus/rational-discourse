    ...
    render() {
        return <Container>
            <Row>
                ...
                <Form.Control ref={inputEl => (this.searchInput = inputEl)} value={this.state.typed} type="text" placeholder="Start typing your tweet" onChange={this.textChangedCallback}></Form.Control>
            </Row>
        </Container>
    }
